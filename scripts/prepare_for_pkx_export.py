...
# (+90 deg about X) — i.e. for a bone pointing straight up, roll 0. A
# from-scratch rig whose root bone carries any other roll/orientation
# exports a rotated root joint; rigs imported through this addon are
# already canonical and skip the fix.
...
if __name__ == "__main__" or True:
    ...
    for arm in armatures:
        ...
        # only the root bone's orientation (and its own animation) changes.
        # Runs before holder-bone insertion so the holder DFS sees the final
        # root orientation.
