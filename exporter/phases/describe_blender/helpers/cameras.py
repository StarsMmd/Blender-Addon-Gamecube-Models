...
# Keep this set in sync with DEBUG_CAMERA_NAME in that script.
...
def describe_cameras(context, logger=StubLogger(), skip_prep_auto=False):
    ...
    Args:
        ...
        skip_prep_auto: When True, drop cameras whose names match
            prepare_for_export.py's auto-generated debug-camera name.
