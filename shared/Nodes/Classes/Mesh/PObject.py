...
class PObject(Node):
    ...
    def build(self, builder):
        ...
        # Remove degenerate faces (faces with repeated vertices) before creating the mesh.
        # These are usually generated by triangle strips changing direction.
        # Assigning normals to an invalid mesh crashes Blender 4.2+.
        self.face_lists, faces = _validate_mesh(self.face_lists, faces)
